...
- `qa.yml` — `QA — Directive Validation`: internal link check (hard fail, verified
  ...
  stays byte-identical across `global.md` and the qa workflow templates), plus a
  warn-only external-link job.
