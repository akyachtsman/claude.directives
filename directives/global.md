...
names the **SHA it was verified at**, re-checked when the finding is written
rather than when the file was fetched — upstream moves inside a session. Read
the file's header comments before reporting it. Read access is unchanged
